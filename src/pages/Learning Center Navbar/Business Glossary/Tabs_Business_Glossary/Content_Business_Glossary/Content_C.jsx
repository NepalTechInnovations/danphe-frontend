const Content_C = () => {
    return (
        <>
            ...
            <p><b>Certificate of Incorporation</b></p>
            <p>
            ...
            <p><b>Closely Held Corporation</b></p>
            <p>
            ...
            <p><b>Compliant</b></p>
            <p>
                "Compliant" refers to a legal entity's responsibility to meet certain requirements to maintain corporate existence under the laws of the jurisdiction in which it is formed. The term is not intended to mean or imply conformity with all federal and state regulatory or tax requirements, which may also exist for operating your business.
            </p>

            <p><b>Consent Resolution</b></p>
            <p>
            ...
            <p>
                Relating to forming an incorporation in the state of Illinois. (1) Something of value, such as money or personal services, given by one party to another in exchange for an act or promise. For example, the amount paid for stock in a corporation. (2) Something promised, given, or done that has the effect of making an agreement a legally enforceable contract.
            </p>
            ...
            <p><b>Corporation</b></p>
            <p>
                An artificial entity created under and governed by the laws of the state of incorporation. Also see the definition of incorporated business for more information.
            </p>

            <p><b>Corporation Law</b></p>
            <p>
                The statutory provisions of a state relating to domestic and foreign corporations.
            </p>

            <p><b>Cumulative Voting</b></p>
            <p>
